...
class __TwigTemplate_cdfe59ca57374a7392b46f49eaf680c4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <script src=\"";
        // line 23
        echo twig_escape_filter($this->env, (isset($context["urlAccountsCdn"]) || array_key_exists("urlAccountsCdn", $context) ? $context["urlAccountsCdn"] : (function () { throw new RuntimeError('Variable "urlAccountsCdn" does not exist.', 23, $this->source); })()));
        echo "\" rel=\"preload\"></script>
    <div id=\"vue-app\" data-context=\"";
        // line 24
        echo twig_escape_filter($this->env, (isset($context["jsContext"]) || array_key_exists("jsContext", $context) ? $context["jsContext"] : (function () { throw new RuntimeError('Variable "jsContext" does not exist.', 24, $this->source); })()));
        echo "\"></div>
";
    ...
    {
        return array (  75 => 24,  71 => 23,  68 => 22,  58 => 21,  35 => 19,);
    }
...
{% block content %}
    <!-- TODO: Migrer le hook pour créer des blocs dynamiques -->
    <script src=\"{{ urlAccountsCdn|e }}\" rel=\"preload\"></script>
    <div id=\"vue-app\" data-context=\"{{ jsContext|e }}\"></div>
{% endblock %}
", "@Modules/ps_edition_basic/views/templates/admin/homepage.html.twig", "/var/www/html/prestashop/modules/ps_edition_basic/views/templates/admin/homepage.html.twig");
    }
}
