 ...
 * @final
 */
class Ps_mbo4114AdminContainer extends Container
{
    private $parameters = [];
    ...
    {
        return $this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, '/var/www/html/prestashop/var/cache/prod/%/ps_mbo');
    }
    ...
    {
        return $this->services['mbo.doctrine.cache.provider'] = new \Symfony\Component\Cache\DoctrineProvider(($this->services['mbo.doctrine.cache.adapter'] ?? ($this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, '/var/www/html/prestashop/var/cache/prod/%/ps_mbo'))));
    }
