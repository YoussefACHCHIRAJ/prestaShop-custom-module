...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.1.7', '/var/www/html/prestashop', false);
    }
    ...
    {
        return $this->services['PrestaShop\\Module\\PrestashopCheckout\\Logger\\LoggerDirectory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('8.1.7', '/var/www/html/prestashop');
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/var/www/html/prestashop/modules/productcomments/src/Entity']);
        $e->addExcludePaths([0 => '/var/www/html/prestashop/modules/productcomments/src/Entity/index.php']);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/var/www/html/prestashop/modules/ps_checkout/src/Entity']);
        $f->addExcludePaths([0 => '/var/www/html/prestashop/modules/ps_checkout/src/Entity/index.php']);
        $g = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/var/www/html/prestashop/modules/ps_accounts/src/Entity']);
        $g->addExcludePaths([0 => '/var/www/html/prestashop/modules/ps_accounts/src/Entity/index.php']);
        $h = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/var/www/html/prestashop/modules/psxdesign/src/Entity']);
        $h->addExcludePaths([0 => '/var/www/html/prestashop/modules/psxdesign/src/Entity/index.php']);
