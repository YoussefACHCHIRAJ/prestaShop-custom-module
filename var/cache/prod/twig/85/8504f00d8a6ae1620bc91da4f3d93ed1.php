...
class __TwigTemplate_7fd2c9a053675ccc6d99cac4c0f17402 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 26
        if ((!twig_in_filter("svg", twig_last($this->env, twig_split_filter($this->env, ($context["headerLogoPath"] ?? null), "."))) && ((($context["form_name"] ?? null) == "email") || (($context["form_name"] ?? null) == "invoice")))) {
            // line 27
            echo "    <form id=\"";
...
";
    ...
    {
        return new Source("", "@Modules/psxdesign/views/templates/admin/logos/Blocks/Partials/logo_form_tabs.html.twig", "/var/www/html/prestashop/modules/psxdesign/views/templates/admin/logos/Blocks/Partials/logo_form_tabs.html.twig");
    }
}
