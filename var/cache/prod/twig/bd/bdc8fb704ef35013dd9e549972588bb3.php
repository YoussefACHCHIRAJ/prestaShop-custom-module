...
class __TwigTemplate_a201b9228439a4c63d1c92eb5b0e92c7 extends Template
{
    private $source;
    private $macros = [];
...
>
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["fontFamily"] ?? null), "id", [], "any", true, true, false, 68)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["font"]) {
                ...
                echo "                        <option
                                ";
                // line 83
                if (((twig_get_attribute($this->env, $this->source, ($context["fontFamily"] ?? null), "value", [], "any", true, true, false, 83)) ? ((twig_get_attribute($this->env, $this->source, ($context["fontFamily"] ?? null), "value", [], "any", false, false, false, 83) == twig_get_attribute($this->env, $this->source, $context["font"], "code", [], "any", false, false, false, 83))) : (twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 83)))) {
                    // line 84
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["weightKey"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["variantKey"]) {
                    ...
                    echo "                        <option
                                ";
                    // line 111
                    if ((twig_get_attribute($this->env, $this->source, ($context["fontStyle"] ?? null), "value", [], "any", false, false, false, 111) == (($context["variantKey"] . "-") . $context["weightKey"]))) {
                        // line 112
                        echo "                                    selected=\"selected\"
                                ";
                    }
    ...
    <textarea
        ...
        // line 172
        echo "        ";
        if ((twig_get_attribute($this->env, $this->source, ($context["textArea"] ?? null), "multiline", [], "any", true, true, false, 172) && (twig_get_attribute($this->env, $this->source, ($context["textArea"] ?? null), "multiline", [], "any", false, false, false, 172) == false))) {
            // line 173
            echo "            rows=\"1\"
        ";
        }
        // line 175
        echo "        ";
        if ((twig_get_attribute($this->env, $this->source, ($context["textArea"] ?? null), "required", [], "any", true, true, false, 175) && (twig_get_attribute($this->env, $this->source, ($context["textArea"] ?? null), "required", [], "any", false, false, false, 175) == true))) {
            // line 176
            echo "            required=\"\"
        ";
        }
        ...
        // line 181
        echo "        ";
        if ((twig_get_attribute($this->env, $this->source, ($context["textArea"] ?? null), "readonly", [], "any", true, true, false, 181) && (twig_get_attribute($this->env, $this->source, ($context["textArea"] ?? null), "readonly", [], "any", false, false, false, 181) == true))) {
            // line 182
            echo "            readonly
        ";
        }
...
";
    ...
    {
        return new Source("", "@Modules/psxdesign/views/templates/components/text_editor.html.twig", "/var/www/html/prestashop/modules/psxdesign/views/templates/components/text_editor.html.twig");
    }
}
