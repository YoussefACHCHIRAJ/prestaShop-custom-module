...
class __TwigTemplate_e066510302499a5eacd856de97969ef2 extends Template
{
    private $source;
    private $macros = [];
...
<form id=\"";
    ...
    ";
        // line 27
        $context["currentStringFormat"] = (((($context["form_name"] ?? null) == "header")) ? (twig_join_filter(($context["headerFormats"] ?? null), ", ")) : (twig_join_filter(($context["otherFormats"] ?? null), ", ")));
        // line 28
        echo "    ";
        $context["currentPreview"] = (((($context["form_name"] ?? null) == "header")) ? (($context["headerLogoPath"] ?? null)) : ((((($context["form_name"] ?? null) == "email")) ? (($context["mailLogoPath"] ?? null)) : (($context["invoiceLogoPath"] ?? null)))));
        // line 29
    ...
    ";
        // line 30
        if ((($context["currentPreview"] ?? null) ==  !null)) {
            // line 31
    ...
    ";
        ...
        ";
        // line 39
        $context["file_uploader_name"] = (((($context["form_name"] ?? null) == "header")) ? ("PS_LOGO") : ((((($context["form_name"] ?? null) == "email")) ? ("PS_LOGO_MAIL") : ("PS_LOGO_INVOICE"))));
        // line 40
...
($context["currentStringFormat"] ?? null), "required" => true]));
    ...
    {
        return new Source("", "@Modules/psxdesign/views/templates/admin/logos/Blocks/Partials/logo_form_image.html.twig", "/var/www/html/prestashop/modules/psxdesign/views/templates/admin/logos/Blocks/Partials/logo_form_image.html.twig");
    }
}
