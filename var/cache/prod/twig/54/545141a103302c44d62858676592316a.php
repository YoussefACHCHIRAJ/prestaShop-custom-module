...
class __TwigTemplate_69d0a729fb77d11485b2f748279278ea extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        // line 30
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 30), "flashbag", [], "any", false, false, false, 30), "peek", [0 => "psxdesign-info"], "method", false, false, false, 30)) > 0)) {
            // line 31
            echo "      ";
  ...
  ";
        ...
        // line 33
        echo "  ";
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 33), "flashbag", [], "any", false, false, false, 33), "peek", [0 => "psxdesign-success"], "method", false, false, false, 33)) > 0)) {
            // line 34
            echo "    ";
  ...
  ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/layout.html.twig", "/var/www/html/prestashop/modules/psxdesign/views/PrestaShop/Admin/layout.html.twig");
    }
}
