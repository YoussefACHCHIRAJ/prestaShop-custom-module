...
class __TwigTemplate_4da550e6651baf7abb4ea9bb0021795c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <ul class=\"row row-cols-1 row-cols-sm-2 row-cols-lg-1 row-cols-xl-2 list-unstyled\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["theme"]) {
            // line 31
            echo "            ";
            $this->loadTemplate("@Modules/psxdesign/views/templates/admin/themes/Blocks/ThemeLibrary/theme_library_content.html.twig", "@Modules/psxdesign/views/templates/admin/themes/Blocks/ThemeLibrary/theme_library_content.html.twig", 31, "175010222")->display(twig_array_merge($context, $context["theme"]));
            // line 75
            echo "        ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return new Source("", "@Modules/psxdesign/views/templates/admin/themes/Blocks/ThemeLibrary/theme_library_content.html.twig", "/var/www/html/prestashop/modules/psxdesign/views/templates/admin/themes/Blocks/ThemeLibrary/theme_library_content.html.twig");
    }
}


/* @Modules/psxdesign/views/templates/admin/themes/Blocks/ThemeLibrary/theme_library_content.html.twig */
class __TwigTemplate_4da550e6651baf7abb4ea9bb0021795c___175010222 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_button_container($context, array $blocks = [])
    {
        ...
        // line 51
        echo "                    ";
        if ((twig_get_attribute($this->env, $this->source, ($context["theme"] ?? null), "name", [], "any", false, false, false, 51) != "classic")) {
            // line 52
            echo "                        <button
                                type=\"button\"
